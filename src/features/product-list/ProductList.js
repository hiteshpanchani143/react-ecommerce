  ...
  return (
    <div>
      ...
      <div>
       ...
       <h1 className='text-4xl font-bold tracking-tight text-gray-900 pt-10'>All Products</h1>
          <div className="flex items-baseline justify-center md:justify-end border-b border-gray-200 pb-6 pt-10">
